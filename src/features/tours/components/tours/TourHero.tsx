            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-12 pr-4 py-6 text-lg rounded-xl border-0 shadow-lg bg-white/90 backdrop-blur placeholder:text-jet/40 text-jet"
                />
              ...
              <div className="flex flex-wrap justify-center gap-3 mt-6">
                <span className="text-sm text-white/60">{t("popular")}</span>
                {["halong", "sapa", "hoian", "mekong", "danang"].map((item) => (
                  <button
                    key={item}
